...
import { FirebaseFormContactRepository } from './firebase/repositories/firebase-form-contact.repository';
...
@NgModule({
  ...
  providers: [
    ...
    { provide: FormContactRepository, useClass: FirebaseFormContactRepository },
